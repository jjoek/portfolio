                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-8">
                                ...
                                <a
                                    href="/infrastructure"
                                    class="nav-link"
                                    :class="{ active: activeSection === 'Infrastructure' }"
                                    >Infrastructure</a
                                >
                            </div>
                        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
                <div class="text-center">
                    ...
                    >
                        ...
                        development, infrastructure automation, and cloud engineering. Passionate
                        about automation, process optimization, and leveraging AI to streamline
                        software delivery.
                    </p>
                    ...
                    >
                        <button class="btn-primary group" @click="showCv">
                            View Resume
                            <svg
                                class="w-4 h-4 ml-2 group-hover:translate-y-0.5 transition-transform duration-200"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                    ...
                    <div class="space-y-6 animate-on-scroll">
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4">
                                ...
                                blend of development expertise and infrastructure automation skills.
                                My journey spans from IT support to leading engineering teams,
                                giving me a comprehensive understanding of the entire technology
                                stack.
                            </p>
                            <p class="text-gray-600 leading-relaxed">
                                Currently pursuing Kubernetes certifications (KCNA, CKA) to deepen
                                my container orchestration skills, I'm passionate about leveraging
                        ...
                        <div>
                            ...
                            <ul class="space-y-2">
                                <li
                                    ...
                                    :key="item"
                                    class="flex items-center text-gray-600 animate-on-scroll"
                                >
                                    <svg
                    ...
                    <div class="space-y-8 animate-on-scroll">
                        ...
                        >
                            ...
                            <div class="flex items-start">
                                <div
                                    class="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center mr-3 mt-1"
                                >
                                    <svg
        ...
        <section id="skills" role="region" aria-label="Technical Skills" class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto animate-on-scroll">
                        A comprehensive toolkit for modern software development and infrastructure
                        automation
                    </p>
                </div>
                ...
                <!-- Learning Path -->
                <div
                    class="mt-16 bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-lg animate-on-scroll"
                >
                    <div class="text-center">
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Currently Learning</h3>
                        <p class="text-gray-600 mb-6">
                            Expanding my expertise in container orchestration and cloud-native
                            technologies
                        </p>
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    ...
                    <div class="space-y-8 animate-on-scroll">
                        <div>
                            ...
                            <p class="text-gray-600 mb-8 leading-relaxed">
                                ...
                                projects, and ways to leverage technology for business growth.
                                Whether you're looking for a senior backend engineer, DevOps
                                expertise, or technical leadership, I'd love to hear from you.
                            </p>
                        </div>
                    ...
                    <div class="space-y-8 animate-on-scroll">
                        <div class="certification-card">
                            ...
                            <div class="space-y-4">
                                <div
                                    v-for="cert in currentCertifications"
                                    :key="cert.name"
                                    class="flex items-center certification-item"
                                >
                                    <div
                        ...
                        <div class="certification-card">
                            ...
                            <div class="space-y-3">
                                <div
                                    v-for="pursuit in currentPursuits"
                                    :key="pursuit"
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <ul class="space-y-2 text-gray-400">
                            <li
                                v-for="cert in footerCertifications"
                                :key="cert.name"
                                class="flex items-center"
                            >
                                <svg
